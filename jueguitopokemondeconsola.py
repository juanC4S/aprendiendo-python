...
if i=="1":
    ...
    while prata >= 0 and ptortuga >=0 :
        ...
        if prata >=100:
            aea = 10 *"-"
            print ("vida de pikachu es:  " ,prata ,aea)
        else:
            print ("vida de pikachu es:  " ,prata ,lifepoker)
            
        if ptortuga >=100:
            print ("vida de squirtle es: " ,ptortuga ,aea ,"\n")
        else:    
            print ("vida de squirtle es: " ,ptortuga ,lifepoket,"\n") 
